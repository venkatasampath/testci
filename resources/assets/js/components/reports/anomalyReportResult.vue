...
export default {
  ...
  computed: {
    data() {
      ...
      this.skeletalElements.forEach(item => {
        let anomalyColumns = {};
        this.skeletalAnomalies.forEach(
          skeletalAnomaly =>
            (anomalyColumns[skeletalAnomaly] = item.anomalys.some(
              el => el.individuating_trait == skeletalAnomaly
            )
              ? "✔"
              : "")
        );
  ...
  methods: {
    getColumns() {
      ...
      this.skeletalAnomalies.forEach(skeletalAnomaly => {
        columns.push({
  ...
  mounted() {
    ...
    console.log(this.skeletalElements, this.anomalies, this.skeletalAnomalies);
  }
};
</script>
