<template>
    <!--This is for widgets with size 6-->
    <section class="row">
        <div class="col-md-6" v-for="widget in widgetsList_Col6" v-if="widget.visible">
            <div class="card" style="margin-bottom: 10px;">
                <div class="card-header" style="margin:0">
                    ...
                    <div style="float: right">
                        ...
                        <a data-toggle="collapse" :data-target="'#widget6_'+widget.id" style="padding-right:.25em;"><i class="far fa-lg fa-minus-square"></i></a>
                        <a v-on:click="HideWidget(widget.id)"><i class="far fa-times-circle fa-lg"></i></a>
                    </div>
                </div>
                <div class="card-body collapse show widget" :id="'widget6_'+widget.id">
                    <div v-if="widget.type == 'Bar'">
                        <barchart
                                v-bind:data-values= 'widget.dataValues'
                                v-bind:chart-class= '"widget6_"+widget.id'
                    ...
                    <div v-if="widget.type == 'StackedBar'">
                        <stackedbarchart
                                v-bind:chart-id= '"widget6_"+widget.id'
                    ...
                    <div v-if="widget.type == 'Map'">
                        <googlemap
                                v-bind:calculated-class= '"widget6_"+widget.id'
                    ...
                    <div v-if="widget.type == 'Table'">
                        ...
                        <datatable
                                ...
                                v-bind:table= '"widget6table_"+widget.id'
                        ></datatable>
                        </div>
