<template>
    <!--This is for widgets with size 3-->
    <section class="row">
        <div class="col-md-3" v-for="widget in widgetsList_Col3" v-if="widget.visible">
            <div class="card" style="margin-bottom: 10px;">
                <div class="card-header" style="margin:0">
                    ...
                    <div style="float: right">
                        ...
                        <a data-toggle="collapse" :data-target="'#widget3_'+widget.id" style="padding-right:.25em;"><i class="far fa-lg fa-minus-square"></i></a>
                        <a v-on:click="HideWidget(widget.id)"><i class="far fa-times-circle fa-lg"></i></a>
                    </div>
                </div>
                <div class="card-body collapse show widget" :id="'widget3_'+widget.id">
                    <div v-if="widget.type == 'Bar'">
                        <barchart
                                v-bind:data-values= 'widget.dataValues'
                                v-bind:chart-class= '"widget3_"+widget.id'
                    ...
                    <div v-if="widget.type == 'StackedBar'">
                        <stackedbarchart
                                v-bind:chart-id= '"widget3_"+widget.id'
                    ...
                    <div v-if="widget.type == 'Map'">
                        <googlemap
                                v-bind:calculated-class= '"widget3_"+widget.id'
                                v-bind:project-details-array='widget.dataValues'>
                        </googlemap>
                    </div>
                    <datatable v-if="widget.type == 'Table' && widget.dataValues[0]"
                               v-bind:chart-class= '"widget3_"+widget.id'
                               v-bind:labels= 'widget.chartLabels'
                               v-bind:table-object= 'widget.dataValues'
                               v-bind:columns= 'widget.datasetLabel'
                               v-bind:table= '"widget3table_"+widget.id'
                    ></datatable>
