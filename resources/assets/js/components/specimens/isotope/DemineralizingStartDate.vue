<template>
    <v-menu
            v-model="DemineralizingStartDate"
    ...
    >
        <template v-slot:activator="{ on }">
            <v-text-field
                    label="Demineralizing Start Date:"
                    placeholder="mm/dd/yyyy"
                    readonly
                    :value="fromDateDisp"
                    v-on="on"
                    dusk="dna-demineralizing_start_date"
        ...
        <v-date-picker
                reactive
                v-model="fromDateVal"
                @input="DemineralizingStartDate = false"
