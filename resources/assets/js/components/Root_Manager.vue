<template>
    <div>
        ...
        <!--<projectheader style="margin-bottom:5px" v-bind:elements= "'Specimens: '+JSON.parse(specimenStats.specimen_stats).se_total" v-bind:individuals= "'Unique Individuals: '+LatestSummaryRecord.num_unique_individuals"></projectheader>-->
...
<script>
    ...
    export default {
        props: {
            ...
            ProjectSeActivity: Array,
            ProjectDnaActivity: Array,
            Provenance1Labels: Array,
            AccessionsByProvenance1: Array,
            fullListANByP1: Array,
        ...
        data() {
            return{
                ...
                widgetList:[
                    ...
                    new Widget(4,'Mito Sequences: '+this.LatestDnaSummaryRecord.num_mito_sequences,4,true, 'Bar', this.mitoSequenceArray, null, this.mitoSequenceLabels, ['#F19A40', '#F19A40', '#F19A40', '#F19A40', '#F19A40'], 'horizontalBar', 'Mito', 'Number of unique mitochondrial DNA sequences, with the total number of skeletal elements per sequence to indicate the sequence with the most skeletal elements.',  null, this.CurrentDateFormatted, "margin-bottom: 10px;"),
                    ...
                    new Widget(15,'Mito Bones & Side',4,true,'StackedBar',this.mitoSequences, this.fullListMito, this.mitoSequenceLabels, null, 'bar', null, 'Number of unique mitochondrial DNA sequences, with the total number of skeletal elements per sequence to indicate the sequence with the most skeletal elements. This view is further described by side and bone.', 'MitoBone', this.CurrentDateFormatted, "margin-bottom: 10px;"),
                    new Widget(7,'Inventory',12,true,'Line', this.inventoryData, null, this.inventoryLabels, null, null, null, null, 'No help text has been provided.', this.SeDateFormatted, "margin-bottom: 10px;"),
                    new Widget(16,'User Activity: Specimens',6,false,'Table', this.UserSeActivity, null, ['Key', 'Name', 'Side', 'Completeness', 'Updated At'], null, null,['skeletalElementsKey', 'name', 'side', 'completeness', 'updated_at'], 'No help text has been provided.', null, null, "margin-bottom: 10px;"),
                    new Widget(17,'User Activity: DNA',6,false,'Table', this.UserDnaActivity, null, ['Key', 'Mito Sequence Number', 'Mito Sequence Subgroup', 'Updated At' ], null, null,['skeletalElementsKey', 'mito_sequence_number', 'mito_sequence_subgroup', 'updated_at'], 'No help text has been provided.', null, null, "margin-bottom: 10px;"),
                    new Widget(18,'Project Activity: Specimens',6,false,'Table', this.ProjectSeActivity, null, ['Key', 'Name', 'Side', 'Completeness', 'Updated By', 'Updated At'], null, null,['skeletalElementsKey', 'name', 'side', 'completeness', 'updated_by', 'updated_at'], 'No help text has been provided.', null, null, "margin-bottom: 10px;"),
                    new Widget(19,'Project Activity: DNA',6,false,'Table', this.ProjectDnaActivity, null, ['Key', 'Mito Sequence Number', 'Mito Sequence Subgroup', 'Updated By', 'Updated At' ], null, null,['skeletalElementsKey', 'mito_sequence_number', 'mito_sequence_subgroup', 'updated_by', 'updated_at'], 'No help text has been provided.', null, null, "margin-bottom: 10px;"),
                    new Widget(20,'Accessions by Provenance1: '+this.Provenance1Count,4,true, 'StackedBar', this.AccessionsByProvenance1, this.fullListANByP1, this.Provenance1Labels, ['#F19A40', '#F19A40', '#F19A40', '#F19A40', '#F19A40'], 'bar', 'Accessions', 'Number of Accessions by Provenace1, provides how many accessions are there in a given provenace1.',  'ANByP1', this.CurrentDateFormatted, "margin-bottom: 10px;"),
                ],
