    ...
    <div class="form-group">
        <div class="col-md-12 p-2 border" style="margin-bottom: 2rem">
            ...
            <div class="col-md-12 p-0" style="margin-bottom: 2rem">
                <a href="{{ url('/exportFileManager') }}" class="btn btn-success" target="_blank"><i class="fas fa-btn fa-eye"></i>@lang('labels.view_model', ['model'=>'Exports'])</a>
                <a href="{{ url('/exportOptions') }}" class="btn btn-primary" target="_blank"><i class="fas fa-btn fa-file-excel"></i>@lang('labels.export')</a>
