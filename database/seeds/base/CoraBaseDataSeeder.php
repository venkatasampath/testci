<?php
/**
 * Cora Base Data Seeder
 *
 * @category   Cora Base Data
 * @package    Seeder
...
class CoraBaseDataSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $this->call(BoneGroupsTableSeeder::class); // Seed the Skeletal Bones groups
        $this->command->info('BoneGroupsTableSeeder tables seeded!');
        ...
        $this->call(MorphologysTableSeeder::class); // Seed morphology data
        $this->command->info('Morphologys table seeded!');
...
//        $this->call(DentalTableSeeder::class);
        $this->call(DentalCodesTableSeeder::class);
        ...
        // Call protected functions in class, to create Labs, Profiles, Import, Export, etc as needed.
        $this->createLabs();
        $this->createProfiles();
...
//        $this->createExportMaps();
    ...
    protected function createProfiles()
    {
        ...
        $profile = Profile::firstOrNew(['name'=>'default_isotope_lab']);
        $data = array('name'=>'default_isotope_lab', 'description'=>'Default Isotope Laboratory', 'default_value'=>1, 'kind'=>'model',
            'display_type'=>'select', 'display_values'=>'"{""model"":""Lab"", ""field"":""name""}"', 'type'=>'user', 'group'=>'isotope', 'display_order'=>2106,
            'help'=>'If set, the lab will be auto-populated on Isotope association screen for Specimen',
            'created_by'=>'System', 'updated_by'=>'System', 'created_at'=>date_create(), 'updated_at'=>date_create());
        (!$profile->exists) ? $profile->fill($data)->save() : $profile->fill(array_except($data, ['created_at']))->save();
