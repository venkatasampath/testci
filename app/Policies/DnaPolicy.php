...
class DnaPolicy extends BasePolicy
{
    ...
    {
        return $this->checkPermission($user, new Dna, 'browse');
    }
    ...
    {
        if ($this->checkPermission($user, new Dna, 'read')) {
                return true;
        }
        return false;
    }
    ...
    {
        return $this->checkPermission($user, new Dna, 'edit');
    }
    ...
    {
        return $this->checkPermission($user, new Dna, 'add');
    }
