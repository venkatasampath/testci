...
class OrgPolicy extends BasePolicy
{
    ...
    public function read(User $user, $model)
    {
        if ($this->checkPermission($user, $model, 'read')) {
            // Checks
            // 1. The user is the org admin to which this model belongs
    ...
    {
        // Only admin user can add new Orgs.
        return false;
    }
...
//    {
//        // Only admin user can delete new Orgs.
//        return false;
//    }
}
